...
class Observation():
    ...
    def __init__(
        ...
        wavelengths : u.Quantity or an interable of u.Quantity
            The AIA wavelengths of interest.
        boxcar_width : int
    ...
    def set_region(
        self,
        RegionClass: typing.Type[regions.SkyRegion],
        ...
        **kwargs
        ...
        self.region = RegionClass(
            SkyCoord(*center, frame=self._coordinate_frame),
            **kwargs
        )
        self.name = name
    ...
    def process(
        ...
        for wavelength in self.wavelengths:
            ...
            lightcurve = lightcurves.make_lightcurve(files, self.region)
            ...
            csv_path = self._build_lightcurve_path()
    ...
    def _preprocess(self):
        ...
        for wavelength in self.wavelengths:
            ...
            map_ = plotting.sunpy.map.Map(files[0].file)
        ...
        self._coordinate_frame = map_.coordinate_frame
    ...
    def _build_path_root(self, dir_format, wavelength):
        ...
        return f'{images_dir}{label}{start_time}-{end_time}_{wavelength}_N{self.boxcar_width}'
